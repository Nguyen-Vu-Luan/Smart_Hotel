...
const PaymentResult = ({ route, navigation }) => {
    const { bookingId, totalPrice, status, roomName, checkIn, checkOut, paymentMethod, services, roomTypeName, basePrice } = route.params;

    console.log("Dữ liệu nhận được từ params:", route.params);
    return (
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Card style={styles.card}>
                <Card.Content>
                    ...
                    {/* Thêm 2 dòng này: */}
                    {roomTypeName && <InfoRow label="Loại phòng" value={roomTypeName} />}
                    <InfoRow label="Giá cơ bản" value={`${Number(basePrice).toLocaleString('vi-VN')} VNĐ`} />
            ...
            <Button mode="outlined" onPress={() => {  }} style={styles.outlineButton}>
