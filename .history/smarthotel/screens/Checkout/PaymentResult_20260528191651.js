...
const PaymentResult = ({ route, navigation }) => {
    const { bookingId, basePrice, totalPrice, status, roomName, checkIn, checkOut, paymentMethod, services } = route.params;
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Card style={styles.card}>
                <Card.Content>
                    ...
                    <InfoRow label="Loại phòng" value={route.params.roomTypeName || 'N/A'} />
                    <InfoRow label="Giá phòng/đêm" value={`${Number(route.params.basePrice || 0).toLocaleString('vi-VN')} VNĐ`} />
