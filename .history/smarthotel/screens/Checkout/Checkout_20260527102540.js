...
const Checkout = ({ route, navigation }) => {
    // Nhận dữ liệu động được truyền sang từ trang Home.js
    ...
    // Đóng gói thông tin khớp cấu trúc Models và Serializer Backend của bạn
    const mockOrderData = {
        roomTypeName: roomTypeName,
        totalPrice: Number(roomPrice) * 1, // Tạm tính 1 đêm (hoặc nhân số đêm tùy ý)
        check_in_date: "2026-05-27",       // Định dạng YYYY-MM-DD bắt buộc cho DateField
        check_out_date: "2026-05-29",      // Định dạng YYYY-MM-DD
        special_requests: "Phòng hướng biển, sạch sẽ",
        // LƯU Ý: Hãy chắc chắn trong DB bảng Room của bạn đã có 1 phòng mang id tương ứng (ví dụ: id là 1)
        details: [
            { room: 1 } 
        ]
    };
