...
const PaymentResult = ({ route, navigation }) => {
    ...
    if (Array.isArray(services) && services.length > 0) {
        console.log("Cấu trúc item đầu tiên:", JSON.stringify(services[0], null, 2));
    } else {
        console.log("Services trống hoặc không phải mảng!");
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {/* //Thay đoạn iconContainer hiện tại bằng đoạn này trong PaymentResult.js */}
            <View style={styles.iconContainer}>
                ...
                {/* Hiển thị dynamic status sếp vừa truyền sang */}
